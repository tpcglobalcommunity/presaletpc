-- =====================================================
-- STORAGE POLICIES FOR PROOF UPLOADS (FINAL VERSION)
-- Copy and paste this script in Supabase SQL Editor
-- Fixed all type casting and array comparison issues
-- =====================================================
...
-- 6. SIMPLE TEST WITHOUT ARRAY COMPARISON
-- Test permissions without problematic array comparison
SELECT '=== SIMPLE PERMISSION TESTS ===' as status;

-- Test if policies exist by name
