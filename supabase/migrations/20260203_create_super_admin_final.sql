-- Create Super Admin - Fix NOT NULL Constraint
-- Email: tpcglobal@gmail.com

-- ================================================================
-- 1. DROP NOT NULL CONSTRAINT FROM user_id
-- ================================================================
...
BEGIN
    ...
    IF EXISTS (
        ...
        RAISE NOTICE '✅ Dropped UNIQUE constraint from user_id';
    END IF;
END $$;

-- ================================================================
-- 2. DROP ROLE CHECK CONSTRAINT
-- ================================================================
...
CREATE TABLE IF NOT EXISTS public.profiles (
    ...
    user_id UUID REFERENCES auth.users(id) ON DELETE CASCADE, -- No NOT NULL
    email TEXT,
...
-- ================================================================
-- 4. CREATE SUPER ADMIN FUNCTIONS
-- ================================================================
...
-- ================================================================
-- 5. CREATE SUPER ADMIN PROFILE FOR tpcglobal@gmail.com
-- ================================================================
