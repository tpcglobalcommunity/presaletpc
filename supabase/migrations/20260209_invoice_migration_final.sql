-- Migration: 20260209_invoice_migration_final.sql
-- Description: Final invoice migration with corrected PostgreSQL syntax
...
EXCEPTION
    WHEN others THEN
        RAISE EXCEPTION 'Failed to convert status column to enum type';
END $do$;
