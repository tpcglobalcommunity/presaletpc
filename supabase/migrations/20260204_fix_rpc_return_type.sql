-- FIX RPC FUNCTION RETURN TYPE
-- Drop and recreate member_get_dashboard_stats with JSON return type

DROP FUNCTION IF EXISTS public.member_get_dashboard_stats();
