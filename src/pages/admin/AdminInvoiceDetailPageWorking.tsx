...
import { FileText, Clock, CheckCircle, XCircle, ArrowLeft, ExternalLink } from 'lucide-react';
...
export default function AdminInvoiceDetailPage() {
  ...
  console.debug('[ADMIN_INVOICE_DETAIL] MOUNTED', {
    invoiceKey,
  ...
  useEffect(() => {
    const fetchInvoice = async () => {
      ...
      try {
        ...
        console.debug('[ADMIN_INVOICE_DETAIL] FETCH RESULT', { data, error });
