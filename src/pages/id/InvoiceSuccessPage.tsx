...
export default function InvoiceSuccessPage() {
  ...
  const setReturnToAfterLogin = (path: string) => {
    try {
      localStorage.setItem('tpc_return_to', path);
    } catch {}
  };
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col px-4 py-8">
      <div className="text-center mb-8 animate-slide-up">
        ...
        <p className="text-muted-foreground">Silakan login untuk konfirmasi pembayaran</p>
      </div>
      ...
      <div className="glass-card mb-8 animate-fade-in">
        ...
        <div className="space-y-3 border-t border-border pt-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm">
              {format(new Date(invoice.created_at), 'd MMMM yyyy, HH:mm', { locale: idLocale })}
            </span>
          </div>
        ...
        <div className="border-t border-border mt-4 pt-4">
          <div className="flex justify-between items-center mb-2">
            ...
            <span className="font-medium">{formatCurrency(invoice.amount_input, invoice.base_currency)}</span>
          </div>
          <div className="flex justify-between items-center mb-2">
      ...
      <button onClick={handleLogin} className="btn-gold w-full text-lg py-5" type="button">
