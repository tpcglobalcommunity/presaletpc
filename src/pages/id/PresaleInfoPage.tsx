            ...
            <Card className="bg-gradient-to-br from-green-500/10 to-green-600/10 backdrop-blur-xl border border-green-500/30 text-white overflow-hidden">
              ...
              <CardContent className="space-y-6">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <div className="text-sm text-gray-400 mb-1">{t('Price', 'Harga')}</div>
                    <div className="text-2xl font-bold text-green-400">
                ...
                <div className="bg-slate-900/50 rounded-lg p-4 border border-slate-700/50">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="font-semibold">{t('Expected ROI', 'ROI yang Diharapkan')}</span>
                  </div>
                  <div className="text-2xl font-bold text-green-400">
                    +{stage1ROI.toFixed(0)}%
                  </div>
            ...
            <Card className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-xl border border-slate-700/50 text-white overflow-hidden">
              <CardContent className="p-8">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Button 
                    size="lg"
                    className="bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-black font-bold px-8 py-3 rounded-xl shadow-lg shadow-amber-500/25 transition-all duration-300 transform hover:scale-[1.02]"
                  ...
                  <Button 
                    size="lg" 
                    variant="outline"
                    className="border-slate-600 text-white hover:bg-slate-800 px-8 py-3 rounded-xl transition-all duration-300"
